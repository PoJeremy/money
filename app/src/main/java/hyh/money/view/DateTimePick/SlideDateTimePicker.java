package hyh.money.view.DateTimePick;
...
public class SlideDateTimePicker
{
    ...
    public static class Builder
    {
        ...
        /**
         * @see hyh.money.view.DateTimePick.SlideDateTimePicker#setListener(SlideDateTimeListener)
         */
        ...
        /**
         * @see hyh.money.view.DateTimePick.SlideDateTimePicker#setInitialDate(java.util.Date)
         */
        ...
        /**
         * @see hyh.money.view.DateTimePick.SlideDateTimePicker#setMinDate(java.util.Date)
         */
        ...
        /**
         * @see hyh.money.view.DateTimePick.SlideDateTimePicker#setMaxDate(java.util.Date)
         */
        ...
        /**
         * @see hyh.money.view.DateTimePick.SlideDateTimePicker#setIs24HourTime(boolean)
         */
        ...
        /**
         * @see hyh.money.view.DateTimePick.SlideDateTimePicker#setTheme(int)
         */
        ...
        /**
         * @see hyh.money.view.DateTimePick.SlideDateTimePicker#setIndicatorColor(int)
         */
